...
/** Referenced from http://www.csee.umbc.edu/~pmundur/courses/CMSC691C/lab5-kurose-ross.html
  *
  */
...
public class Server extends JFrame implements ActionListener {
  ...
  static LineReader RTSPBufferedReader;
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    RTSPBufferedReader = new LineReader(new BufferedReader(new InputStreamReader(theServer.RTSPsocket.getInputStream())));
    ...
    while(!done)
    {
      ...
      {
        theServer.send_RTSP_response_options();
      }
    }
...
//
	  ...
	  {
	    System.out.println("Exception caughtl233: "+ex);
	    System.exit(0);
	  }
      }
    else
  ...
  private int parse_RTSP_request()
  {
    ...
    try{
      ...
      {
        System.out.println("Exception caughtl295: "+ex);
        System.exit(0);
      }
    return(request_type);
  }
  ...
  private void send_RTSP_response()
  {
    try{
      ...
      {
	System.out.println("Exception caught315: "+ex);
	System.exit(0);
      }
  }

  private void send_RTSP_response_options()
  {
    try{
      System.out.println("debug sending rtsp");
      RTSPBufferedWriter.write("RTSP/1.0 200 OK"+CRLF);
      RTSPBufferedWriter.write("CSeq: "+RTSPSeqNb+CRLF);
      RTSPBufferedWriter.write("Session: "+RTSP_ID+CRLF);
      ...
      {
  System.out.println("Exception caughtl332: "+ex);
  System.exit(0);
      }
  }
}